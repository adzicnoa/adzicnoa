...
<title>NOA ADŽIĆ MOJ HTML</title>

</head>
<body>
<body style="background-color:#F18B8B;">
	<h1>Noa Adžić</h1>
...
<nav>
		<ul>
			<li><a href="sva predavanja i osvrti.html">Osvrt</a></li>
			<li><a href="sve slikovne vježbe.html
">Slikovne vježbe</a></li>
			<li><a href="video vježba.html">Video</a></li>
			<li><a href="STRANICA\Stranica.html
">Web stranica</a></li>
		</ul>
	</nav>
